...
const InfoItem = ({ label, value }: { label: string; value: string }) => (
    <div className="py-6 first:pt-0 last:pb-0 border-b border-black/5 dark:border-white/5 last:border-0">
        <span className="block text-xs uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500 mb-2">{label}</span>
...
export const AboutMe: React.FC = () => {
    return (
        <section id="about" className="py-32 bg-gray-50 dark:bg-black transition-colors duration-200">
            <Layout>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">

                    {/* Left: Stats/Info */}
                    <div className="lg:col-span-5 xl:col-span-4">
                        <h2 className="text-4xl font-bold mb-10 lg:hidden text-gray-900 dark:text-white tracking-tight">About Me</h2>
                        <div className="px-2">
                    ...
                    <div className="lg:col-span-7 xl:col-span-8 pt-2">
                        <h2 className="hidden lg:block text-5xl font-bold mb-10 text-gray-900 dark:text-white tracking-tight">About Me</h2>
                        <div className="prose prose-xl dark:prose-invert text-gray-600 dark:text-gray-400 leading-relaxed font-light">
                            <p className="mb-8">
