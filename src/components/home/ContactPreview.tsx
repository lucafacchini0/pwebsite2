...
export const ContactPreview: React.FC = () => {
    return (
        <section className="h-screen flex items-center bg-zinc-50 dark:bg-black text-center transition-colors duration-200 border-t border-black/5 dark:border-white/5">
            <Layout>
